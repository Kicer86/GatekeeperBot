...
class BotConfig:
    ...
    user_auto_refresh_roles_message_id: Union[Tuple[int, int], List[Tuple[int, int]]] = None # (channel id, message id) or a list thereof
    ids_channel_id: Optional[int] = None                                                    # channel to put user ids
